...
;; 	      ))
;;       ;;      (setq ispell-personal-dictionary "~/emacs/misc/hunspell.en")
;;       )
;;      ;; aspell
;;      ;; install with brew install aspell --with-lang-en
;;      ;; see: http://stackoverflow.com/questions/26647412/homebrew-could-not-symlink-usr-local-bin-is-not-writable
;;      ;; needed to also do a:
...
;;      ;;
;;      ;; followed by a
;;      ;; brew link --overwrite aspell
;;      ;; (aspell-file
;;      ;;  (setq ispell-program-name aspell-file)
;;      ;;  (setq ispell-dictionary "en_US")
;;      ;;  ;;(setq ispell-personal-dictionary "~/emacs/misc/aspell.en.pws")
;;      ;;  )
;;      ;; ispell
;; ;;      (ispell-file
;; ;;       (setq ispell-program-name ispell-file)
;; ;; ;;      (setq ispell-personal-dictionary "~/emacs/misc/ispell.en")
;; ;;       )
;;      ))
;;   ;;
...
;;                                  (interaction)
;;                                  (mouse--down-2-maybe-follows-link)))
;;   ;;
